...
from .views import CakeListView, CakeDetailView,CategoryListView, CategoryDetailView, PaymentDetailView, PaymentListView, UserDetailView, UserListView, home # Import view
